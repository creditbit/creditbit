...
const string strMessageMagic = "creditbit Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    nSubsidy >>= (pindexBest->nHeight / 129600);
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "creditbit", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "creditbit is the next big thing";
        CTransaction txNew;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xa3b080be48c42ce068b699a0464fa786382a66b583d52b601509117519d26fd4"));
        block.print();
